                ...
                <div class="box_background">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 jumbotron">
                            ...
                            <h3>Gana autoridad competitiva</h3>
                        
                            <h2 class="brand-before">
                                <small class="text-center"> 
                                    Tu imagen empresarial en Internet podrá ser comparable a cualquier gran compañía de tu mismo sector. Es un terreno imparcial donde el sitio web de una empresa pequeña puede ser tanto o más encantador que el de una empresa muy grande. 
                                </small>
                            </h2>
                        </div>  
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-8 jumbotron">
                            ...
                            <h2 class="brand-before">
                                <small class="text-center"> 
                                    Con tan solo poseer un sitio web, tus clientes podrán consultar informacion en todo momento, 
                                    ahorrando tiempo, dinero y reduciendo el número de llamadas telefónicas en el proceso.
                                </small>
                            </h2>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 jumbotron">
                            ...
                            <h2 class="brand-before">
                                <small class="text-center">
                                    Actualmente las empresas respetadas en el medio tienen presencia en la Web. 
                                    El no contar con una dirección en Internet, puede dar una imagen poco seria y carente de profesionalidad. 
                                </small>
                            </h2>         
                        </div>    
                    </div>
		...
		<div class="container">
	        ...
	        <header class="page-header">
                <div class="jumbotron">
                    ...
                    ningun conocimiento sobre el diseño web?</p>
                        
                    <p class="lead"> ¿Llevas años con tu negocio, pero tu pagina web 
                    ya esta obsoleta en relacion a las nuevas tecnologias web que han emergido 
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-12 col-xs-12 text-justify color-white">
                    ...
                    <p>Para lograr esto, realizo servicios personalizados de consultoría, diseño y programación de sitios web, que no solo satisfagan estéticamente, sino que cumpla con los objetivos comerciales que necesita el cliente. </p>

                    <p>Tres características esenciales describen mi trabajo:</p> 
                ...
                <div class="row">
                    <section class="detalle-servicio col-md-4 text-center-portrait margin-40px-portrait">
                        ...
                        <div class="text">
                            ...
                            <h2>Consultoría</h2>
                            <p>Es el primer paso, antes de comenzar cualquier proyecto.
                            Las consultorías tienen como finalidad conocer todas las necesidades del cliente, 
                            y ofrecer un diseño de pagina que satisfaga o supere las expectativas de estos. </p>
            ...
            <div>
                <header class="jumbotron">
                    <div class="container text-center color-white">
                        ...
                        <p class="color-white">Dale click a las imágenes para ver mis proyectos de
                        forma on-line</p>
                        <hr />
                    </div>
                </header>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 margin-5 portafolio-item 
